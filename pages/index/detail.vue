		...
		<template v-if="goodsDict.id != null">
			...
			<view class="goods-introduce common">
				<view class="goods-price">
					...
					<view v-if="goodsDict.rewardIntegral>0" style="background-color: #e74032;color: #fff;border-radius: 40rpx; padding: 8rpx;font-size: 22rpx; margin-left: 30rpx;" >
			...
			initData() {
				...
				self.Get(`/api/plugs/searchPlugsGoodsById?id=${this.id}`).then(res => {
					if (res.code == 200) {
						...
						// console.log(this.goodsDict,'商品888888888详情')
						self.getcollectList();
					}
				})
